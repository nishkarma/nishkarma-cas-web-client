 ...
 * @since 3.1
 */
public abstract class NishkarmaAbstractCasProtocolUrlBasedTicketValidator extends NishkarmaAbstractUrlBasedTicketValidator {

    protected NishkarmaAbstractCasProtocolUrlBasedTicketValidator(final String casServerUrlPrefix) {
