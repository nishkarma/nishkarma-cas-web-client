...
public final class NishkarmaSingleSignOutHandler {
    ...
    public boolean process(final HttpServletRequest request, final HttpServletResponse response) {
		...
		for (Enumeration<java.lang.String> e = request.getParameterNames(); e.hasMoreElements();) {
			...
			logger.debug("---Logout-req-pname={}", pname);
			
			java.lang.String[] pvalues = request.getParameterValues(pname);
			
			for (String pvalue:pvalues) {
				logger.debug("-------Logout-req-pvalue={}", pvalue);
			}
		}    	
