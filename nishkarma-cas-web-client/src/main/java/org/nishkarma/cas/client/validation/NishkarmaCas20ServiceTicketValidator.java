 ...
 * @since 3.1
 */
public class NishkarmaCas20ServiceTicketValidator extends NishkarmaAbstractCasProtocolUrlBasedTicketValidator {
     ...
     */
    public NishkarmaCas20ServiceTicketValidator(final String casServerUrlPrefix) {
    ...
    protected final Assertion parseResponseFromServer(final String response) throws TicketValidationException {
    	...
    	logger.debug("---parseResponseFromServer--response={}", response);
