 ...
 * @since 3.1
 */
public abstract class NishkarmaAbstractTicketValidationFilter extends AbstractCasFilter {
    ...
    protected NishkarmaAbstractTicketValidationFilter(final Protocol protocol) {
        super(protocol);
    }
