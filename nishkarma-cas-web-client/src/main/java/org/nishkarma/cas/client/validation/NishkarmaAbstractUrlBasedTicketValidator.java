 ...
 * @since 3.1
 */
public abstract class NishkarmaAbstractUrlBasedTicketValidator implements TicketValidator {
     ...
     */
    protected NishkarmaAbstractUrlBasedTicketValidator(final String casServerUrlPrefix) {
