...
public class NishkarmaSingleSignOutFilter extends AbstractConfigurationFilter {

	private static final NishkarmaSingleSignOutHandler HANDLER = new NishkarmaSingleSignOutHandler();
	...
	protected static NishkarmaSingleSignOutHandler getSingleSignOutHandler() {
		return HANDLER;
	}
}
