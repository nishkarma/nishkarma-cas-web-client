 ...
 * @since 3.1
 */
public class NishkarmaCas20ProxyTicketValidator extends NishkarmaCas20ServiceTicketValidator {
    ...
    public NishkarmaCas20ProxyTicketValidator(final String casServerUrlPrefix) {
